      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 260px), 1fr))', gap: '20px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          {reminderEvents.length ? (
            <div style={{ padding: '16px', borderRadius: '18px', background: 'var(--bg)', border: '1px solid var(--panel-border)', display: 'flex', flexDirection: 'column', gap: '12px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', gap: '12px', alignItems: 'center', flexWrap: 'wrap' }}>
                ...
                <button className="ghost" type="button" onClick={refreshReminderInbox} style={{ padding: '8px 12px', borderRadius: '12px' }}>
                  Refresh
                </button>
              </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div style={{ padding: '16px', borderRadius: '18px', background: 'var(--bg)', border: '1px solid var(--panel-border)' }}>
            <h3 style={{ margin: '0 0 12px', fontSize: '1rem', display: 'flex', alignItems: 'center', gap: '6px' }}><Music size={16} /> Environment</h3>
            ...
            <div className="preset-row" style={{ marginTop: '12px' }}>
            ...
            <label className="input-block compact" htmlFor={themeId} style={{ padding: 0, marginTop: '12px', background: 'transparent', border: 'none' }}>
